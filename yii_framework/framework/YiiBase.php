	...
	public static function autoload($className)
	{
		...
		else
		{
			...
			if(strpos($className,'\\')===false)  // class without namespace
			{
				...
				$casArray=array("CAS_Client", "CAS_Languages_English", "CAS_Languages_LanguageInterface", "CAS_Request_CurlRequest", "CAS_Request_AbstractRequest", "CAS_Request_RequestInterface", "CAS_GracefullTerminationException", "CAS_Exception", "CAS_ProxyChain_AllowedList");
					if (!in_array($className, $casArray))
						include($className.'.php');
